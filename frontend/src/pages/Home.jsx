        ...
        <div className="grid grid-cols-1 lg:grid-cols-4 gap-6">
          ...
          <div className="lg:col-span-3 space-y-6">
            ...
            {result && result.type === "text" && (
              <div className="backdrop-blur-xl bg-white/5 border border-white/10 p-6 rounded-xl shadow-xl space-y-4">

                <h2 className="text-xl font-bold">Compliance Result</h2>

                <div>
                  <span
                    className={
                      result.data.verdict === "fail"
                ...
                <div>
                  <h3 className="font-semibold mb-2">LLM Reply</h3>
                  <pre className="bg-black/50 p-3 rounded">
                    {result.data.llm_reply}
                  </pre>
                </div>

                <div>
                  <h3 className="font-semibold mb-2">Retrieved Triples</h3>
                  <pre className="bg-black/50 p-3 rounded whitespace-pre-wrap">
                    {result.data.triples_text}
                  </pre>
                </div>
